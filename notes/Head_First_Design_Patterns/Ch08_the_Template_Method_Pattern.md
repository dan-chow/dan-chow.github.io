...
#### &#x1F448; [Prev](./Ch07_the_Adapter_and_Facade_Patterns.md)
#### &#x1F449; [Next](./Ch09_the_Iterator and_Composite_Patterns.md)

## Chapter 08: the Template Method Pattern

- Template method pattern  
![alt text](res/fig_8_1_Template_method_pattern.PNG)  
...
![alt text](res/fig_8_2_Template_method_pattern_class_diagram.PNG)  
...
- design principle  
![alt text](res/fig_8_3_Design_principle_8_1.PNG)  

- the Hollywood principle  
![alt text](res/fig_8_4_The_Hollywood_principle.PNG)  

- sorting with template method  
![alt text](res/fig_8_5_Sorting_with_template_method.PNG)  
